...
<html:form
	action="/EstadisticasPublicacionDoAction.do"
	...
	<logic:messagesPresent>
		...
		<fieldset>
			...
			<div class="detalle">
				<label>
					<bean:message key="estadisticas.organismo" bundle="resources" /> 
					
				</label>
				<html:select name="EstadisticasPublicacionForm" property="opcionOrganismo">
					<html:option value="">
					<bean:message key="estadisticas.todos" bundle="resources" />
					
					</html:option>
					<html:optionsCollection name="EstadisticasPublicacionForm"  property="listaOrganismos" label="label"
						value="value" />
				</html:select>
			</div>
