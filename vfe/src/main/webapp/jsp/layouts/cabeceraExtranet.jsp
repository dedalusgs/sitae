	...
	<div id="cabecera">
		<div id="celda_izq">			
            ...
            <% if (organismoVisualizar!=null){ %>	
           		<a href="./InitDoAction.do" title="<bean:message key='portal.titulo' bundle='resources'/>">
		...
		<%if(organismoVisualizar != null){%>
			<%if(organismoVisualizar.getImagen() != null){%>		
				<img title="<%=organismoVisualizar.getNombre() %>" height="68" src="<%=request.getSession().getAttribute("rutaEscudo")%>" />
			<%}else {%>
