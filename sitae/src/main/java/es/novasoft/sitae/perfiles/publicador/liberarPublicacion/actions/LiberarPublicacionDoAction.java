...
public class LiberarPublicacionDoAction extends ActionBase {
	...
	protected ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (idEdicto != null && !idEdicto.equals("")) {
				...
				asunto = mailconfig.getString("asuntoLiberarPublicacion") + " " + edicto.getTitulo();
				...
				String texto = mailconfig.getString("textoLiberarPublicacionNombre") + " : " + edicto.getTitulo();
				texto = texto + mailconfig.getString("textoLiberarPublicacionNombre2") + " " + formulario.getMotivos() + mailconfig.getString("textoLiberarPublicacionNombre3");
				texto = mailconfig.getString("textoLiberarPublicacionNombreVa") + " : " + edicto.getTituloVa();
				texto = texto + mailconfig.getString("textoLiberarPublicacionNombre2Va") + " " + formulario.getMotivos() + mailconfig.getString("textoLiberarPublicacionNombre3Va");
				...
				if (edicto.getEstado().getIdEstado().equals(Constantes.REVISION)) {
