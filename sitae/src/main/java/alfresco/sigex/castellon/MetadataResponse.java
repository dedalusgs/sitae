...
public class MetadataResponse  implements java.io.Serializable {
    private alfresco.sigex.castellon.Metadata[] arrayOfMetadata;
    ...
    public MetadataResponse(
           alfresco.sigex.castellon.Metadata[] arrayOfMetadata,
     ...
     */
    public alfresco.sigex.castellon.Metadata[] getArrayOfMetadata() {
        return arrayOfMetadata;
    }
     ...
     */
    public void setArrayOfMetadata(alfresco.sigex.castellon.Metadata[] arrayOfMetadata) {
        this.arrayOfMetadata = arrayOfMetadata;
    }

    public alfresco.sigex.castellon.Metadata getArrayOfMetadata(int i) {
        return this.arrayOfMetadata[i];
    }

    public void setArrayOfMetadata(int i, alfresco.sigex.castellon.Metadata _value) {
