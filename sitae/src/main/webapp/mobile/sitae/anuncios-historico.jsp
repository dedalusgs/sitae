...
<h4><bean:message key="historicoEdictos.titulo" bundle="resources" /></h4>
			<p><bean:message key="mobile.historico.texto" bundle="resources" /></p>
...
<logic:notEmpty name="VisualizarEdictoPublicoForm"
		...
		<display:table name="${VisualizarEdictoPublicoForm.listaPublicados}"
			...
			requestURI="./HistoricoFrontAction.do" export="false">
