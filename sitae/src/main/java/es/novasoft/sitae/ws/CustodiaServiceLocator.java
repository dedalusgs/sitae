...
public class CustodiaServiceLocator extends org.apache.axis.client.Service
		implements es.novasoft.sitae.ws.CustodiaService {
	...
	public CustodiaServiceLocator(java.lang.String wsdlLoc,
	...
	private java.lang.String AlmacenarDocumento_address = "https://10.0.10.31:443/afirmaws/services/AlmacenarDocumento";
	...
	public es.novasoft.sitae.ws.Custodia getAlmacenarDocumento()
			throws javax.xml.rpc.ServiceException {
	...
	public es.novasoft.sitae.ws.Custodia getAlmacenarDocumento(
		...
		try {
			es.novasoft.sitae.ws.AlmacenarDocumentoSoapBindingStub _stub = new es.novasoft.sitae.ws.AlmacenarDocumentoSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (es.novasoft.sitae.ws.Custodia.class
					.isAssignableFrom(serviceEndpointInterface)) {
				es.novasoft.sitae.ws.AlmacenarDocumentoSoapBindingStub _stub = new es.novasoft.sitae.ws.AlmacenarDocumentoSoapBindingStub(
						new java.net.URL(AlmacenarDocumento_address), this);
				_stub.setPortName(getAlmacenarDocumentoWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName(
				"http://afirmaws/services/AlmacenarDocumento",
				"CustodiaService");
	}
