...
<h4><bean:message key="mobile.busqueda.avanzadatitulo" bundle="resources"/></h4>
			<p><bean:message key="mobile.busqueda.texto" bundle="resources"/></p>
...
<logic:notEmpty name="VisualizarEdictoPublicoForm"
		...
		<display:table name="${VisualizarEdictoPublicoForm.listaPublicados}"
			...
			requestURI="./BusquedaAvanzadaFrontAction.do" export="false">
			...
			<display:column media="html" class="listado_expedientes" headerClass="cabecera_tabla">
				<center>
					<a href="./MuestraInfoEdictoFrontAction.do?idEdictoSeleccionado=${nuevaListaPublicados.id}"  data-ajax="false" data-transition="slidefade" class=" ui-btn ui-btn-icon-notext ui-corner-all ui-icon-action ui-nodisc-icon ui-alt-icon"></a>
				</center>
			</display:column>
