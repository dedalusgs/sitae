...
<%@ taglib uri="http://jakarta.apache.org/struts/tags-bean" prefix="bean" %>
					...
					<h4><bean:message key="muestraInformacionOrganismoExterno.titulo" bundle="resources"/></h4>												
					
					<div class="error" >
							<p><bean:message key="muestraInformacionOrganismoExterno.error" bundle="resources"/></p>
					</div>					
