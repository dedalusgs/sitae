	...
	<script type="text/javascript">
		...
		function enviar(){
			...
			formulario.submit();
		    			  ...
		    			  <html:form action="/VisualizarFestivoFrontAction.do?actualizaAnio=si" method="post" enctype="multipart/form-data" styleId="formularioAnio">
								<fieldset>
										<legend>
		    			  ...
		    			  <h3><bean:message key="festivos.tituloFestivosLocales" bundle="resources"/></h3>	
		    			  <html:form action="/AltaFestivoFrontAction.do" method="post" enctype="multipart/form-data">		  	
		    			 <logic:notEmpty name="VisualizarFestivoForm" property="diasFestivosLocales" >	
		    			    
	  					 <display:table export="true" name="${VisualizarFestivoForm.diasFestivosLocales}"  id="diasFestivosLocales" pagesize="10" sort="list"
	  					 requestURI="./VisualizarFestivoFrontAction.do">
							...
							<display:column media="html" class="listado_representantes" headerClass="cabecera_tabla ancho-20">
								...
								<center>
									<html:link action="/ModificarFestivoFrontAction.do" paramId="idFestivoSeleccionado" paramName="diasFestivosLocales" paramProperty="id">			
							...
							<display:column media="html" class="listado_expedientes" headerClass="cabecera_tabla ancho-20">					
								...
								<center>
									<html:link action="/EliminarFestivoDo.do" paramId="idFestivoSeleccionado" paramName="diasFestivosLocales" paramProperty="id">
						 ...
						 <logic:empty name="VisualizarFestivoForm" property="diasFestivosLocales"> 				
					...
					<logic:empty name="VisualizarFestivoForm" property="diasFestivosLocales"> 				
							...
							<html:form action="/CopiarFestivoDoAction.do" method="post" enctype="multipart/form-data">
					...
					<h3><bean:message key="festivos.titulolistadoFestivosLocales" bundle="resources"/></h3>	
						<form >	
		    			  <logic:notEmpty name="VisualizarFestivoForm" property="diasFestivosNacionales" >	   		  	
	  					 ...
	  					 requestURI="./VisualizarFestivoFrontAction.do">
							...
							<display:column class="listado_representantes" headerClass="cabecera_tabla" property="fechaString" title="${fechaProperty}"/>		   
    						<display:column class="cabecera_tabla ancho-600" headerClass="cabecera_tabla" property="nombre" title="${nombreProperty}"/>    												
