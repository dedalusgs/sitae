...
public class ConfirmarSuscripcionDoAction extends ActionBase {

	private static Log log = LogFactory.getLog(ConfirmarSuscripcionDoAction.class);
			...
			if (codigoActivacion == null) {
				...
				if (interesados.size() > 0) {
					...
					if (!interesado.activo()) {
						interesado.setBooleanActivo(Boolean.TRUE);
