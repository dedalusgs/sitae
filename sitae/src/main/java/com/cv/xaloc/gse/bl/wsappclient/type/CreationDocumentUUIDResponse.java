...
public class CreationDocumentUUIDResponse  implements java.io.Serializable {
    ...
    private com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] arrayOfSigner;
    ...
    public CreationDocumentUUIDResponse(
           ...
           com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] arrayOfSigner,
     ...
     */
    public com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] getArrayOfSigner() {
        return arrayOfSigner;
    }
     ...
     * @param arrayOfSigner
     */
    public void setArrayOfSigner(com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] arrayOfSigner) {
        this.arrayOfSigner = arrayOfSigner;
    }

    public com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid getArrayOfSigner(int i) {
        return this.arrayOfSigner[i];
    }

    public void setArrayOfSigner(int i, com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid _value) {
