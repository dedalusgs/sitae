...
<%@page language='java' import='java.util.*,es.novasoft.sitae.perfiles.adminLocal.modificarFestivo.forms.ModificarFestivoForm,org.apache.struts.util.LabelValueBean' %>
<%
...
function recargarDias(){
    ...
    for (i=diasMes;i>0;i--) { 
		...
		<h3><bean:message key="servicio.gestionFestivos" bundle="resources"/></h3>		 
			...
			<html:form action="/ModificarFestivoGlobDo.do" method="post" enctype="multipart/form-data">			
				...
				<logic:messagesPresent>
			  	...
			  	<fieldset>	
			  		...
			  		<legend><bean:message key="festivo.tituloModificar" bundle="resources"/></legend>					
					 	
					 	<div class="detalle"> 
					 	   <label><bean:message key="festivo.nombre" bundle="resources"/>(*)</label>
							<html:text name="ModificarFestivoForm" property="nombre"/>
						 </div>
						 <div class="detalle"> 
				...
				<div class="botonera">
						<html:submit>						
							...
							<html:form action="/ModificarFestivoGlobFrontAction.do?volver=si">
