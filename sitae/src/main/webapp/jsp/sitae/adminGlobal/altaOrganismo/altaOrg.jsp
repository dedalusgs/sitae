			  	...
			  	<fieldset>	
			  		...
			  		<legend><bean:message key="altaOrganismo.titulo" bundle="resources"/></legend>					
						...
						<div class="detalle"> 
							...
							<html:text name="AltaOrganismoForm" property="organismo.cif" maxlength="20"/>
						</div>
						...
						<div class="detalle">
							<label><bean:message key="datosorganismo.aliasSello" bundle="resources"/>(*)</label>
							<html:text name="AltaOrganismoForm" property="organismo.aliasSello" maxlength="255"/>
						</div>		
