...
<ul id="breadcrumbs">
		...
		<% if( !grupoNavegacion.equals("-1")){%>
			...
			<% if(grupoNavegacion.equals("5")){%>
				<li><bean:message key="datosedicto.listacorreo" bundle="resources"/></li>
			<% } %>
		<% } else { %>
...
<% if( !servicioNavegacion.equals("-1")){%>	
	...
	<% if(servicioNavegacion.equals("-5")){%>
		<h2 class="tit_certificat"><bean:message key="datosedicto.listacorreo" bundle="resources"/></h2>	
	<% } %>	
	...
	<% } %>
	<% if(servicioNavegacion.equals("121")){%>
		<h2 class="tit_certificat"><bean:message key="servicio.gestionFestivos" bundle="resources"/></h2>	
	<% } %>
	<% if(servicioNavegacion.equals("122")){%>
		<h2 class="tit_certificat"><bean:message key="servicio.estadisticasPublicacion" bundle="resources"/></h2>	
	<% } %>
	<% if(servicioNavegacion.equals("123")){%>
		<h2 class="tit_certificat"><bean:message key="servicio.redesSociales" bundle="resources"/></h2>	
	<% } %>
