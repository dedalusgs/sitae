 ...
 */
public class DescargaDocumentoOriginalServlet extends DownloadAction {
	private static final long serialVersionUID = 1L;
	private static final Log LOGGER = LogFactory.getLog(DescargaDocumentoOriginalServlet.class);
	...
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		byte[] pdf_adjunto = formulario.getVerificador().getDocument();
