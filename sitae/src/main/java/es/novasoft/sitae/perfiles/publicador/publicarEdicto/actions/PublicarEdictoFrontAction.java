package es.novasoft.sitae.perfiles.publicador.publicarEdicto.actions;
...
import es.novasoft.sitae.perfiles.publicador.publicarEdicto.forms.PublicarEdictoForm;

public class PublicarEdictoFrontAction extends ActionBase {
	...
	protected ActionForward executeAction(ActionMapping mapping,
		...
		try {
			...
			PublicarEdictoForm formulario = (PublicarEdictoForm) form;
			...
			request.setAttribute("PublicarEdictoForm", formulario);

		} catch (Exception e) {
			e.printStackTrace();
			LOGGER.error("Error en PublicarEdictoFront", e);
