package es.novasoft.sitae.perfiles.publicador.modificarMisRedacciones.forms;
...
public class ModificarMisRedaccionesForm extends FormBase {
	...
	public ModificarMisRedaccionesForm() {
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		if (fechaRedaccion.equals("")) {
			errors.add(null, new ActionMessage("errors.required", LenguajeUtil.getMensaje(request, "datosedicto.fechaRedaccion")));
		} else {
			if ((!ValidatorUtils.validaFecha(fechaRedaccion, LenguajeUtil.getMensaje(request, "datosedicto.fechaRedaccion"), true))) {
				errors.add(null, new ActionMessage("errors.fecha_formato", LenguajeUtil.getMensaje(request, "datosedicto.fechaRedaccion")));
			}
		}
		...
		if (ValidatorUtils.validaFecha(fechaRetirada, LenguajeUtil.getMensaje(request, "datosedicto.fechaRetiradaPropuesta"), true)
				...
				&& ValidatorUtils.validaFecha(fechaRedaccion, LenguajeUtil.getMensaje(request, "datosedicto.fechaRedaccion"), true)) {
			...
			if (FechasUtil.compareDates(FechasUtil.convertStringToDate(fechaRetirada, 0), FechasUtil.convertStringToDate(fechaRedaccion, 0))
					|| FechasUtil.compareDates(FechasUtil.convertStringToDate(fechaPublicacion, 0), FechasUtil.convertStringToDate(fechaRedaccion, 0))) {
				errors.add(null, new ActionMessage("errors.fechaRedaccion"));
			}
		}
		if (getListaCorreo()) {
		...
		try {
			...
			Logger.getLogger(ModificarMisRedaccionesForm.class.getName()).log(Level.SEVERE, null, ex2);
			errors.add(null, new ActionMessage("errors.formatoPdf"));
