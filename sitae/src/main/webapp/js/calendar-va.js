...
"- Mantinga polsat el ratolí en qualsevol d'estos botons per a una selecció ràpida.";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
"Selecció d'hora:\n" +
"- Polse en qualsevol de les parts de l'hora per a incrementar-la\n" +
"- o polse les majúscules mentres fa clic per a decrementarla\n" +
"- o faça clic i arrossegament el ratolí per a una selecció més ràpida.";

Calendar._TT["PREV_YEAR"] = "Any anterior (mantindre per a menú)";
Calendar._TT["PREV_MONTH"] = "Mes anterior (mantindre per a menú)";
Calendar._TT["GO_TODAY"] = "Anar a hui";
Calendar._TT["NEXT_MONTH"] = "Mes següent (mantindre per a menú)";
Calendar._TT["NEXT_YEAR"] = "Any següent (mantindre per a menú)";
...
Calendar._TT["TIME_PART"] = "(Majúscula-)Clic o arrossegament per a canviar valor";
