...
public class SolicitarPublicacionResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the idAnuncio value for this SolicitarPublicacionResponse.
     * 
     * @return idAnuncio
     */
    ...
    /**
     * Sets the idAnuncio value for this SolicitarPublicacionResponse.
     * 
     * @param idAnuncio
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ttdev.com/ss", ">solicitarPublicacionResponse"));
