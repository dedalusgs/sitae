...
<%@taglib uri="http://struts.apache.org/tags-nested" prefix="nested" %>
				...
				<h3><bean:message key="servicio.gestionUsuarios" bundle="resources"/></h3>			  		 
	  		     ...
	  		     <fieldset>
			   		...
			   		<legend><span><label><bean:message key="muestraInformacionUsuarioExterno.titulo" bundle="resources"/></label></span></legend>					
						
							<div class="detalle"> 
						 	   <label><bean:message key="organismoExterno.aplicacion" bundle="resources"/></label>
								<bean:write name="MuestraInformacionUsuarioForm" property="usuario.nombre"/>
							</div>
							<div class="detalle"> 
						 	   <label><bean:message key="datosusuario.nombreUsuario" bundle="resources"/></label>
								<bean:write name="MuestraInformacionUsuarioForm" property="usuario.numDocumento"/>
							</div> 
						 	
						 	<div class="detalle">
								<label><bean:message key="datosusuario.password" bundle="resources"/></label>
								<bean:write name="MuestraInformacionUsuarioForm" property="usuarioExterno.password" />
							</div>
							...
							<c:if test="${(MuestraInformacionUsuarioForm.usuario.idPerfil=='3')}">
								...
								<logic:notEmpty name="MuestraInformacionUsuarioForm" property="listaCentrosAsignados">																																			
									...
									<display:table name="${MuestraInformacionUsuarioForm.listaCentrosAsignados}"  id="listaCentrosAsignados" pagesize="10" sort="list">
