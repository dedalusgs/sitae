...
public class VisualizarEdictoPublicadorForm extends FormBase {
	...
	public VisualizarEdictoPublicadorForm() {
	...
	public String getCodigoEdicto() {
		return codigoEdicto;
	}

	public void setCodigoEdicto(String codigoEdicto) {
		this.codigoEdicto = codigoEdicto;
	}
