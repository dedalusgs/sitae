	...
	<body>
		...
		<div id="cuerpo">
			...
			<div id="contenido">
				...
				<div class="content">
					<h5>
						El usuario  tiene la  siguiente funcionalidad:
					</h5>
					<br>
					<li>
						...
						<ul style='margin-bottom: 1em'>
							...
							pudiéndose descargar el edicto, el certificado de publicación  y la diligencia del
							edicto.
						</ul>
						<ul style='margin-bottom: 1em'>
							·
							...
							de publicación del edicto y la diligencia del
							edicto.
						</ul>
					</li>
				...
				<div class="content">
					...
					<br>
					<p>
						Puede verse la información que se muestra en la imagen además de poder descargarse:
					</p>
					<li>
						<ul style='margin-bottom: 1em'>
							· Icono
							...
							<span style='margin-left: 2em'> : Descargar PDF del Edicto
								asociado a la publicación de dicho Edicto. </span>
						</ul>
						<ul style='margin-bottom: 1em'>
							· Icono
							<img src="img/ico-descargar-publicacion.gif"></img>
							<span style='margin-left: 2em'> : Descargar PDF
								Certificado Publicación Edicto asociado a la publicación de dicho
								Edicto. </span>
						</ul>
						<ul style='margin-bottom: 1em'>
					...
					<li>
						...
						<ul style='margin-bottom: 1em'>
							...
							Certificado Publicación Edicto.
						</ul>
					</li>
					<br />
					<a
