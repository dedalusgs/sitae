package es.novasoft.sitae.perfiles.publicador.rechazarPublicacion.forms;
...
public class RechazarPublicacionForm extends FormBase {
	...
	public RechazarPublicacionForm() {
