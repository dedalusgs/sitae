...
public class ContentSignerResponse  implements java.io.Serializable {
    private com.cv.xaloc.gse.bl.wsappclient.type.Signer signer;
    ...
    public ContentSignerResponse(
           com.cv.xaloc.gse.bl.wsappclient.type.Signer signer,
     ...
     * @return signer
     */
    public com.cv.xaloc.gse.bl.wsappclient.type.Signer getSigner() {
        return signer;
    }
     ...
     * @param signer
     */
    public void setSigner(com.cv.xaloc.gse.bl.wsappclient.type.Signer signer) {
        this.signer = signer;
    }
