...
public class FirmaServiceLocator extends org.apache.axis.client.Service implements afirmaws.services.ValidarFirma.FirmaService {
    ...
    private java.lang.String ValidarFirma_address = "https://preafirma.accv.es:443/afirmaws/services/ValidarFirma";
    ...
    public afirmaws.services.ValidarFirma.Firma getValidarFirma() throws javax.xml.rpc.ServiceException {
    ...
    public afirmaws.services.ValidarFirma.Firma getValidarFirma(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            afirmaws.services.ValidarFirma.ValidarFirmaSoapBindingStub _stub = new afirmaws.services.ValidarFirma.ValidarFirmaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (afirmaws.services.ValidarFirma.Firma.class.isAssignableFrom(serviceEndpointInterface)) {
                afirmaws.services.ValidarFirma.ValidarFirmaSoapBindingStub _stub = new afirmaws.services.ValidarFirma.ValidarFirmaSoapBindingStub(new java.net.URL(ValidarFirma_address), this);
                _stub.setPortName(getValidarFirmaWSDDServiceName());
                return _stub;
            }
        }
