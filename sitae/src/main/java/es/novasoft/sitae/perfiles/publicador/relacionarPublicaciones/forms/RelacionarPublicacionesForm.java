package es.novasoft.sitae.perfiles.publicador.relacionarPublicaciones.forms;
...
public class RelacionarPublicacionesForm extends FormBase {
	...
	public RelacionarPublicacionesForm() {
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		...
		this.listaRelacionados = new ArrayList<ObjetoEdictoVisualizar>();
