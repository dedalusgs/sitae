...
public class ArrayOfDocumentVersion  implements java.io.Serializable {
    private com.cv.xaloc.gse.bl.wsappclient.type.DocumentVersion[] arrayOfDocumentVersion;
    ...
    public ArrayOfDocumentVersion(
           com.cv.xaloc.gse.bl.wsappclient.type.DocumentVersion[] arrayOfDocumentVersion,
     ...
     */
    public com.cv.xaloc.gse.bl.wsappclient.type.DocumentVersion[] getArrayOfDocumentVersion() {
        return arrayOfDocumentVersion;
    }
     ...
     */
    public void setArrayOfDocumentVersion(com.cv.xaloc.gse.bl.wsappclient.type.DocumentVersion[] arrayOfDocumentVersion) {
        this.arrayOfDocumentVersion = arrayOfDocumentVersion;
    }

    public com.cv.xaloc.gse.bl.wsappclient.type.DocumentVersion getArrayOfDocumentVersion(int i) {
        return this.arrayOfDocumentVersion[i];
    }

    public void setArrayOfDocumentVersion(int i, com.cv.xaloc.gse.bl.wsappclient.type.DocumentVersion _value) {
