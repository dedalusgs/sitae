...
public class FirmaServiceLocator extends org.apache.axis.client.Service implements afirmaws.services.FirmaServidor.FirmaService {
    ...
    private java.lang.String FirmaServidor_address = "https://preafirma.accv.es:443/afirmaws/services/FirmaServidor";
    ...
    public afirmaws.services.FirmaServidor.Firma getFirmaServidor(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            afirmaws.services.FirmaServidor.FirmaServidorSoapBindingStub _stub = new afirmaws.services.FirmaServidor.FirmaServidorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (afirmaws.services.FirmaServidor.Firma.class.isAssignableFrom(serviceEndpointInterface)) {
                afirmaws.services.FirmaServidor.FirmaServidorSoapBindingStub _stub = new afirmaws.services.FirmaServidor.FirmaServidorSoapBindingStub(new java.net.URL(FirmaServidor_address), this);
                _stub.setPortName(getFirmaServidorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://afirmaws/services/FirmaServidor", "FirmaService");
    }
