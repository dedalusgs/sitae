/**
 * CollatedDocumentsResponse.java
 *
...
public class CollatedDocumentsResponse  implements java.io.Serializable {
    private com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] arrayOfDocuments;

    private com.cv.xaloc.gse.bl.wsappclient.type.AlfrescoError[] errors;

    public CollatedDocumentsResponse() {
    }

    public CollatedDocumentsResponse(
           com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] arrayOfDocuments,
    ...
    /**
     * Gets the arrayOfDocuments value for this CollatedDocumentsResponse.
     * 
     * @return arrayOfDocuments
     */
    public com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] getArrayOfDocuments() {
        return arrayOfDocuments;
    }


    /**
     * Sets the arrayOfDocuments value for this CollatedDocumentsResponse.
     * 
     * @param arrayOfDocuments
     */
    public void setArrayOfDocuments(com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid[] arrayOfDocuments) {
        this.arrayOfDocuments = arrayOfDocuments;
    }

    public com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid getArrayOfDocuments(int i) {
        return this.arrayOfDocuments[i];
    }

    public void setArrayOfDocuments(int i, com.cv.xaloc.gse.bl.wsappclient.type.DocumentUuid _value) {
        this.arrayOfDocuments[i] = _value;
    }


    /**
     * Gets the errors value for this CollatedDocumentsResponse.
     * 
     * @return errors
     */
    ...
    /**
     * Sets the errors value for this CollatedDocumentsResponse.
     * 
     * @param errors
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CollatedDocumentsResponse)) return false;
        CollatedDocumentsResponse other = (CollatedDocumentsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CollatedDocumentsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:castellon:sigex:alfresco:type:v1.0.0", ">CollatedDocumentsResponse"));
