...
public class ContentDocumentResponse implements java.io.Serializable {
	...
	private Signer[] arrayOfSigner;

	private AlfrescoError[] errors;

	public ContentDocumentResponse() {
	}

	public ContentDocumentResponse(byte[] content, java.lang.String name,
			java.lang.String mimeType, Signer[] arrayOfSigner,
			AlfrescoError[] errors) {
	 ...
	 */
	public Signer[] getArrayOfSigner() {
		return arrayOfSigner;
	}
	 ...
	 * @param arrayOfSigner
	 */
	public void setArrayOfSigner(Signer[] arrayOfSigner) {
		this.arrayOfSigner = arrayOfSigner;
	}

	public Signer getArrayOfSigner(int i) {
		return this.arrayOfSigner[i];
	}

	public void setArrayOfSigner(int i, Signer _value) {
	 ...
	 * @return errors
	 */
	public AlfrescoError[] getErrors() {
		return errors;
	}
	 ...
	 * @param errors
	 */
	public void setErrors(AlfrescoError[] errors) {
		this.errors = errors;
	}

	public AlfrescoError getErrors(int i) {
		return this.errors[i];
	}

	public void setErrors(int i, AlfrescoError _value) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof ContentDocumentResponse))
			return false;
		...
		_equals = true
				...
				&& ((this.arrayOfSigner == null && other.getArrayOfSigner() == null) || (this.arrayOfSigner != null && java.util.Arrays
						.equals(this.arrayOfSigner, other.getArrayOfSigner())))
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			ContentDocumentResponse.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"urn:castellon:sigex:alfresco:type:v1.0.0",
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"urn:castellon:sigex:alfresco:type:v1.0.0", "arrayOfSigner"));
		elemField.setXmlType(new javax.xml.namespace.QName(
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"urn:castellon:sigex:alfresco:type:v1.0.0", "errors"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"urn:castellon:sigex:alfresco:type:v1.0.0", "AlfrescoError"));
		elemField.setNillable(false);
		elemField.setMaxOccursUnbounded(true);
		typeDesc.addFieldDesc(elemField);
	}
