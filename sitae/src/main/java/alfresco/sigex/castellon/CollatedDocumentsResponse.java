...
public class CollatedDocumentsResponse  implements java.io.Serializable {
    private alfresco.sigex.castellon.DocumentUuid[] arrayOfDocuments;
    ...
    public CollatedDocumentsResponse(
           alfresco.sigex.castellon.DocumentUuid[] arrayOfDocuments,
     ...
     */
    public alfresco.sigex.castellon.DocumentUuid[] getArrayOfDocuments() {
        return arrayOfDocuments;
    }
     ...
     */
    public void setArrayOfDocuments(alfresco.sigex.castellon.DocumentUuid[] arrayOfDocuments) {
        this.arrayOfDocuments = arrayOfDocuments;
    }

    public alfresco.sigex.castellon.DocumentUuid getArrayOfDocuments(int i) {
        return this.arrayOfDocuments[i];
    }

    public void setArrayOfDocuments(int i, alfresco.sigex.castellon.DocumentUuid _value) {
