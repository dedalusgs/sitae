...
public class CustodiaServiceLocator extends org.apache.axis.client.Service implements afirmaws.services.AlmacenarDocumento.CustodiaService {
    ...
    public afirmaws.services.AlmacenarDocumento.Custodia getAlmacenarDocumento() throws javax.xml.rpc.ServiceException {
    ...
    public afirmaws.services.AlmacenarDocumento.Custodia getAlmacenarDocumento(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            afirmaws.services.AlmacenarDocumento.AlmacenarDocumentoSoapBindingStub _stub = new afirmaws.services.AlmacenarDocumento.AlmacenarDocumentoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (afirmaws.services.AlmacenarDocumento.Custodia.class.isAssignableFrom(serviceEndpointInterface)) {
                afirmaws.services.AlmacenarDocumento.AlmacenarDocumentoSoapBindingStub _stub = new afirmaws.services.AlmacenarDocumento.AlmacenarDocumentoSoapBindingStub(new java.net.URL(AlmacenarDocumento_address), this);
                _stub.setPortName(getAlmacenarDocumentoWSDDServiceName());
                return _stub;
            }
        }
