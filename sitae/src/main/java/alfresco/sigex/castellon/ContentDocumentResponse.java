...
public class ContentDocumentResponse  implements java.io.Serializable {
    ...
    private alfresco.sigex.castellon.Signer[] arrayOfSigner;
    ...
    public ContentDocumentResponse(
           ...
           alfresco.sigex.castellon.Signer[] arrayOfSigner,
     ...
     */
    public alfresco.sigex.castellon.Signer[] getArrayOfSigner() {
        return arrayOfSigner;
    }
     ...
     * @param arrayOfSigner
     */
    public void setArrayOfSigner(alfresco.sigex.castellon.Signer[] arrayOfSigner) {
        this.arrayOfSigner = arrayOfSigner;
    }

    public alfresco.sigex.castellon.Signer getArrayOfSigner(int i) {
        return this.arrayOfSigner[i];
    }

    public void setArrayOfSigner(int i, alfresco.sigex.castellon.Signer _value) {
