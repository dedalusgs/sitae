...
public class CancelarSolicitudPublicacionResponse  implements java.io.Serializable {
    ...
    public java.lang.String getCorrecto(int i) {
        return this.correcto[i];
    }

    public void setCorrecto(int i, java.lang.String _value) {
        this.correcto[i] = _value;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((this.correcto==null && other.getCorrecto()==null) || 
             (this.correcto!=null &&
              java.util.Arrays.equals(this.correcto, other.getCorrecto()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCorrecto() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCorrecto());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCorrecto(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ttdev.com/ss", ">cancelarSolicitudPublicacionResponse"));
